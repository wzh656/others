<title>simplex-noise.js test</title>
<body>
...
var 什么鬼 = new SimplexNoise('什么鬼');
visualize('什么鬼 noise2D x100', function(x, y) {
  return 什么鬼.noise2D(x / 100, y / 100);
});
...
visualize('more3D z1 x20', function(x, y) {
  return simplex.more3D(x / 20, y / 20, 1, 3);
});
document.writeln("<hr/>运行:"+(new Date()-start)+"ms");
</script>
